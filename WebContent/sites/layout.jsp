	...
	<header id="header" class="page-header bg-white b-b">
		<div class="navbar navbar-expand-lg">
			...
			<a href="home" class="navbar-brand w w-auto-sm"> <svg width="32" height="32" viewBox="0 0 512 512"
                ...
                </svg><span class="hidden-folded d-inline l-s-n-1x w w-auto-sm">LOFI CHILL</span>
			</a>
			<!-- / brand -->
			<!-- Navbar collapse -->
					...
					<div class="padding">
						<div class="py-5 text-sm text-muted">
							<div class="row">
								...
								<div class="col-12 col-sm-9">Copyright &copy; 2024 LOFI CHILL. All rights reserved.</div>
							</div>
						</div>
					</div>
				</div>
